...
import { Award, User, CheckCircle, Target, ShieldCheck, Heart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-base-100 flex flex-col">
      ...
      >
        ...
        <section className="text-center mb-32 relative">
          ...
          >
            Certify was born from a simple observation: achievements are valuable, 
            but their proof is often fragmented and uncertain. We bridge that gap.
          </motion.p>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-40 items-start">
          <motion.div variants={REVEAL_ITEM} className="space-y-12">
            <div>
              ...
              <h2 className="text-4xl font-black tracking-tighter mb-6">Our Mission</h2>
              <p className="text-lg font-medium leading-relaxed text-base-content/70">
                To provide a decentralized, beautiful, and effortless environment where every 
                accomplishment—from a workshop mini-course to a corporate leadership program—is 
                verifiable instantly and securely.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <div key={i} className="p-6 rounded bg-base-200/50 border border-base-200">
                  <val.icon className="text-primary mb-4" size={24} />
                  <h3 className="font-black text-sm uppercase tracking-widest">{val.title}</h3>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            <div className="rounded bg-base-200 aspect-[4/5] overflow-hidden border border-base-200 relative group">
              ...
              <div className="absolute bottom-8 left-8 right-8 p-8 rounded bg-white/10 backdrop-blur-md border border-white/20 text-white">
                <p className="text-2xl font-black tracking-tighter mb-2">Since 2026</p>
                <p className="text-sm font-bold opacity-80 uppercase tracking-widest text-white/70">Leading the Digital Identity Wave</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <section className="mb-40 py-20 border-y border-base-200">
          <motion.div variants={REVEAL_ITEM} className="text-center mb-16">
            ...
            <p className="text-base-content/50 font-bold uppercase tracking-widest text-sm">Built for Scalability and Integrity</p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <div className="font-bold text-base-content/80 text-sm uppercase tracking-wide">{tech}</div>
              </motion.div>
            ))}
          </div>
        </section>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-16">
              ...
              <div className="flex-1 text-center md:text-left">
                <h2 className="text-5xl font-black tracking-tighter mb-4">Wunna Aung</h2>
                <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-8">
                  <span className="px-4 py-1.5 rounded bg-white/10 text-primary font-black text-xs uppercase tracking-[0.2em]">Founder</span>
                  <span className="px-4 py-1.5 rounded bg-white/10 text-white/50 font-black text-xs uppercase tracking-[0.2em]">Product Lead</span>
                </div>
                <p className="text-xl font-medium opacity-80 leading-relaxed mb-8 italic">
                  "Certify isn't just about making documents. It's about preserving the dignity of achievement. 
                  Every student and professional deserves a verification layer that is as strong as their willpower."
                </p>
                <div className="h-px w-20 bg-primary/50 mb-8 mx-auto md:mx-0" />
                <p className="font-bold uppercase tracking-widest text-primary text-sm">Dreamed in Myanmar, Built for the World.</p>
              </div>
            </div>
          </motion.div>
        </section>
