...
import { HelpCircle, MessageCircle, Mail, Sparkles, ShieldCheck, Award } from 'lucide-react';
    ...
    items: [
      {
        ...
        answer: "Yes! Currently, our platform allows you to create, issue, and verify an unlimited number of certificates at no cost. This is part of our commitment to professional growth for all."
      },
      {
        question: "How long does verification take?",
        answer: "Every verification query is instant. Our centralized registry ensures that as soon as you hit search, the result is computed in less than 500ms."
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        answer: "Absolutely. We use digital signing and immutable record-keeping ensures that any modification to a certificate after issuance will invalidate its security hash."
      },
      {
        question: "What happens if I lose my certificate link?",
        answer: "Certificates are permanently stored. You can always retrieve them via your dashboard or by using the unique Certificate ID printed on the document."
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        answer: "Our premium Template Builder supports custom logo uploads, primary/secondary branding colors, and dynamic font selection to match your brand book."
      },
      {
        question: "What export formats are supported?",
        answer: "Certify supports high-resolution PDF for professional printing and high-fidelity PNG images optimized for LinkedIn and social media sharing."
      }
    ]
  }
];
    ...
    <div className="min-h-screen bg-base-100 flex flex-col">
      ...
      >
        ...
        <section className="text-center mb-32 relative">
          ...
          >
            Find answers to common questions about designing, issuing, 
            and verifying digital credentials on the Certify platform.
          </motion.p>
        </section>
          ...
          {FAQ_ITEMS.map((category, catIdx) => (
            <motion.section key={catIdx} variants={REVEAL_ITEM}>
              <div className="flex items-center gap-4 mb-12 border-b border-base-200 pb-8">
                ...
                <div>
                  <h2 className="text-3xl font-black tracking-tight text-base-content">{category.category}</h2>
                  <p className="text-sm font-bold text-base-content/40 uppercase tracking-widest">{category.items.length} Articles</p>
                </div>
              </div>
        ...
        >
           ...
           <div className="relative text-center md:text-left flex-1">
             ...
             <h2 className="text-4xl font-black tracking-tighter mb-4">Still seeking answers?</h2>
             <p className="text-xl font-medium opacity-70 mb-0">Our dedicated support lead is available 24/7 to solve your technical or branding hurdles.</p>
           </div>
           ...
           <div className="relative flex flex-col gap-4 w-full md:w-auto">
             ...
             <p className="text-center text-xs font-black uppercase tracking-widest opacity-40">Response time: ~2 hours</p>
           </div>
        </motion.section>
      </motion.main>
      <Footer />
