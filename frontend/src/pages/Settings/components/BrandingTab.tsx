      ...
      >
        <div className="flex items-start justify-between gap-4 mb-8 pb-6 border-b border-base-200/60">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black tracking-tight text-base-content uppercase tracking-widest text-[16px] mb-1">White Label Identity</h2>
              <p className="text-sm text-base-content/55 font-medium leading-relaxed">Customize verification pages to reflect your premium branding.</p>
            </div>
          </div>
          <div className="hidden lg:flex items-center gap-2 bg-base-200/40 px-4 py-2 rounded border border-base-200">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-base-content/30 italic">Corporate Tier</span>
          </div>
        </div>
        ...
        {!canManageWorkspace && (
          <div className="alert border-info/20 bg-info/5 rounded mb-8 flex items-start gap-4 p-5">
            ...
            <div className="flex-1">
              <p className="text-sm font-black text-base-content/80 tracking-tight mb-0.5">Administrative-Only View</p>
              <p className="text-xs font-medium text-base-content/50 leading-relaxed">
                White-label branding and public-facing identity settings are managed exclusively by Workspace Owners.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mb-8">
          ...
          <div className="space-y-6">
            <Input
              ...
              placeholder="verify@organization.io"
              disabled={!canManageWorkspace}
              className="h-11 bg-base-200/10"
            ...
            <Input
              ...
              hint="Required for standalone brand verification."
              disabled={!canManageWorkspace}
              className="h-11 bg-base-200/10"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="form-control group">
            ...
            <div className="flex items-center gap-5 bg-base-200/30 p-5 rounded border border-base-200 group-hover:border-primary/20 transition-all">
              ...
              />
              <div>
                <p className="font-mono text-xl font-black text-base-content tracking-tight">{brandPrimaryColor.toUpperCase()}</p>
                <p className="text-[10px] font-black text-base-content/30 uppercase tracking-[0.22em] mt-1 italic">Brand Lead Tone</p>
              </div>
            </div>
          </div>
          <div className="form-control group">
            ...
            <div className="flex items-center gap-5 bg-base-200/30 p-5 rounded border border-base-200 group-hover:border-base-400 transition-all">
              ...
              />
              <div>
                <p className="font-mono text-xl font-black text-base-content tracking-tight">{brandSecondaryColor.toUpperCase()}</p>
                <p className="text-[10px] font-black text-base-content/30 uppercase tracking-[0.22em] mt-1 italic">Visual Balance Tone</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between p-5 bg-primary/[0.03] rounded border border-primary/10 transition-all hover:bg-primary/[0.06] mb-8 cursor-pointer">
          <div className="flex-1">
            <p className="font-black text-[15px] text-base-content/80 tracking-tight flex items-center gap-2">Discrete White Labeling <span className="brand-tag !h-5 !px-3 !py-1 !tracking-widest !text-[9px] mb-0.5">Enterprise</span></p>
            <p className="text-xs font-medium text-base-content/45 leading-relaxed mt-1">Remove all platform attribution from recipient verification dashboards.</p>
          </div>
        ...
        <div className="flex items-center justify-between border-t border-base-200/60 pt-8">
          <div className="flex-1 mr-6">
            {whiteLabelSaved && (
              <motion.div initial={{ opacity: 0, x: -15 }} animate={{ opacity: 1, x: 0 }} className="alert border-success/30 bg-success/10 py-3 rounded gap-3">
                <ShieldCheck size={16} className="text-success" />
                <span className="text-xs font-black uppercase tracking-widest text-success">White-label parameters synced!</span>
              </motion.div>
            )}
            {whiteLabelError && (
              <div className="text-error text-xs font-black uppercase tracking-widest px-1">{whiteLabelError}</div>
            )}
          </div>
          <Button
            variant="primary"
