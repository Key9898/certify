...
const TERM_SECTIONS = [
  {
    ...
    icon: FileCheck,
    content:
      'By creating an account and using the Certify platform, you agree to these legal terms and conditions. If you disagree with any part, you must not use our services.',
  },
  {
    title: 'User Responsibilities',
    icon: Info,
    content:
      'Users are responsible for ensuring that they have the legal right to issue any certificate they create. Misuse of the platform for fraudulent purposes will result in account termination.',
  },
  {
    title: 'Platform Rights',
    icon: ShieldAlert,
    content:
      'Certify reserves the right to modify, suspend, or terminate services at any time. We also reserve the right to remove any content that violates our community guidelines.',
  },
  {
    title: 'Limitation of Liability',
    icon: ShieldAlert,
    content:
      "Certify is provided 'as is'. We are not liable for any indirect, incidental, or physical damages resulting from the use or inability to use our platform.",
  },
];
          ...
          <section className="md:col-span-8 space-y-16">
            ...
            >
              ...
              <p className="opacity-70 mb-8 font-medium">
                Contact our legal representative for further clarification on
                these terms.
              </p>
              <a
                href="mailto:legal@certify.ink"
                className="btn btn-warning px-8 rounded font-black text-white"
              >
                legal@certify.ink
              </a>
            </motion.div>
          ...
          <aside className="md:col-span-4 hidden md:block">
            <div className="sticky top-32 space-y-12">
              <div className="p-8 rounded bg-amber-50 border border-amber-200">
                <h4 className="font-black uppercase tracking-[0.2em] text-xs text-amber-700 mb-8">
                  Quick Navigation
                </h4>
                <ul className="space-y-4">
                  {TERM_SECTIONS.map((s, i) => (
                    <li key={i}>
                      <a
                        href="#"
                        className="font-bold text-sm text-slate-600 hover:text-amber-700 transition-colors flex items-center gap-2"
                      >
              ...
              <div className="p-8 rounded bg-amber-500/5 border border-amber-500/20">
                ...
                <p className="text-sm font-bold text-base-content/70 leading-relaxed italic">
                  "Transparency is the foundation of our trust. These terms
                  protect both the issuer and the recipient."
                </p>
              </div>
            </div>
          </aside>
