...
import { ShieldCheck, Mail, Clock, Lock, ShieldAlert, FileText } from 'lucide-react';
...
const POLICY_SECTIONS = [
  {
    ...
    icon: Mail,
    content: "We collect information you provide directly to us when creating an account, including your organization name, email address, and any branding assets (logos/signatures) you upload."
  },
  {
    title: "Information Usage",
    icon: ShieldCheck,
    content: "Your data is used solely to generate and verify certificates. We do not sell your data to third parties. We use your email for critical account alerts and platform updates."
  },
  {
    title: "Data Storage & Security",
    icon: Lock,
    content: "We implement industry-standard encryption and security measures. All assets are stored securely on Cloudinary and MongoDB-protected environments."
  },
  {
    title: "User Rights",
    icon: ShieldAlert,
    content: "You have the right to access, export, or delete your data at any time. To request data deletion, please contact our support team at support@certify.ink."
  }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-20 mb-32">
          ...
          <section className="md:col-span-8 space-y-16">
            ...
            <motion.div variants={REVEAL_ITEM} className="p-10 rounded bg-slate-900 text-white">
                <h3 className="text-2xl font-black tracking-tighter mb-4">Contact Our Privacy Lead</h3>
                <p className="opacity-70 mb-8 font-medium">For any inquiries regarding data protection and GDPR compliance.</p>
                <a href="mailto:privacy@certify.ink" className="btn btn-primary px-8 rounded font-black">
                  privacy@certify.ink
                </a>
            </motion.div>
          </section>
          ...
          <aside className="md:col-span-4 hidden md:block">
            <div className="sticky top-32 space-y-12">
               <div className="p-8 rounded bg-base-200 border border-base-200">
                  <h4 className="font-black uppercase tracking-[0.2em] text-xs text-primary mb-8">Quick Access</h4>
                  <ul className="space-y-4">
                    {POLICY_SECTIONS.map((s, i) => (
                        <li key={i}>
                            <a href="#" className="font-bold text-sm text-slate-600 hover:text-primary transition-colors flex items-center gap-2">
               ...
               <div className="p-8 rounded bg-primary/5 border border-primary/20">
                  ...
                  <p className="text-sm font-bold text-base-content/70 leading-relaxed italic">
                    "We believe your data is your property. Our platform is built to respect that fundamental right."
                  </p>
               </div>
            </div>
          </aside>
