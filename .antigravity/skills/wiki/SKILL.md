...
> **Note:** This is the Antigravity IDE port. The Cursor IDE version lives at [`.cursor/skills/wiki/SKILL.md`](../../../.cursor/skills/wiki/SKILL.md) and the Trae version lives at [`.trae/skills/wiki/SKILL.md`](../../../.trae/skills/wiki/SKILL.md). They share the same intent and folder layout — keep all in sync.
